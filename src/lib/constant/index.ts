...
const landingPageServices = {
    ...
    'currency': {
        ...
        contentDesc: 'Merchants can process fast and errorless crypto transactions in top currencies supported by Our platform. They are widely accepted and are consistently being improved..',
    },
    'unlimited': {
        key: 'unlimited',
...
const landingPageCryptoSteps = {
    'step-1': {
        ...
        desc: 'The customer chooses to pay with crypto using our payment method.',
    },
    'step-2': {
        key: 'step-2',
        icon: Icons.eth,
    ...
    'step-4': {
        ...
        desc: 'Our system processes the your withdrawal request and sends the payment in the preferred cryptocurrency.',
    },
};
...
export const statusLabelMap = {
    ...
    succeed: 'succeed',
    accepted: 'processing',
    aml_processing: 'processing', //todo ask
    aml_suspicious: 'processing', //todo ask
    confirmation_fail: 'processing',
    ...
    failed: 'failed', //todo ask
    refunded: 'refunded',
    canceled: 'canceled', //todo ask
    rejected: 'rejected',
};
...
export const getStatusLabelAndColor = (status: string): [string, string | any] => {
    return [
        fnCapitalize(statusLabelMap[status] || status),
        statusColorMap[statusLabelMap[status]] || 'default',
    ];
};
