...
export const BgCircle: React.FC = () => {
    const [bgColors, scrollPercentage] = useScrollColors(['red', 'blue', 'yellow'], [300, 500, 400, 600]);

    return (
        <div
            className={clsx('fixed inset-x-0 bottom-0 z-0 flex items-center justify-between transition', { 'opacity-0': scrollPercentage > 97 })}>
