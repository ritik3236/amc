...
export const BgCircle: React.FC = () => {
    const [bgColors, scrollPercentage] = useScrollColors(['red', 'blue', 'blue', 'yellow', 'red', 'blue', 'yellow'], [300, 500, 400, 600]);
    ...
    return (
        <div
            ...
            <div
                // eslint-disable-next-line tailwindcss/no-custom-classname
                className={`bg-${bgColors[3]} h-40 w-1/5 animate-move rounded-full a-delay-3`}/>
        </div>
    );
};
