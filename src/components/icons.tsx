        ...
        <svg className="scale-x-[200%]" height="100%" id="svg" viewBox="0 0 1440 690" width="100%"
            ...
            <defs>
                <linearGradient id="gradient" x1="60%" x2="40%" y1="1%" y2="99%">
                    <stop offset="5%" stopColor="#023298"/>
                    <stop offset="95%" stopColor="#023298"/>
                </linearGradient>
            </defs>
            <path
...
export const Icons = {
    ...
    deposit: LuArrowDownToDot,
    download: LuArrowDownToLine,
    dice: LuDices,
    dot: LuDot,
    ellipseH: LuMoreHorizontal,
    ellipseV: LuMoreVertical,
    filterCross: LuFilterX,
    flower: LuFlower,
    gamepad: LuGamepad,
    gitMerge: LuGitMerge,
    globe: LuGlobe,
    ...
    settings: LuSettings,
    shop: LuStore,
    slideFilter: LuSlidersHorizontal,
    tag: LuTag,
    trash: LuTrash,
    tree: LuTreePine,
    undo: LuUndo2,
