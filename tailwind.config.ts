...
module.exports = {
    ...
    safelist: [
        {
            pattern: /bg-(red|blue|yellow)-(300|400|500|600)/,
        },
    ],
    theme: {
        extend: {
